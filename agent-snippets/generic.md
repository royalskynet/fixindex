...
Triggers: the user names a system + a symptom, uses a failure verb
...
run the specific subcommand. Never grep blindly when the user named a
system that maps cleanly to an existing fix file.
